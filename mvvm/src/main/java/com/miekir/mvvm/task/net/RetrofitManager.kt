...
import com.miekir.mvvm.task.net.utils.InterceptorUtils
...
class RetrofitManager private constructor() {
     ...
     * 打印网络日志，仅第一次使用有效
     */
    fun printLog(print: Boolean, vararg ignoreKeys: String): RetrofitManager {
        if (print) {
            mClientBuilder.addInterceptor(InterceptorUtils.getLogInterceptor(*ignoreKeys))
        }
        return this
    }
